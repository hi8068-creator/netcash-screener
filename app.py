...
SHORT_DESC = {
    ...
    "新業種": "独自60業種(試験版)", "業種根拠": "分類の信頼度", "規模": "TOPIX規模区分",
...
HEADER_LABELS = {
    "来期見通し(短信抜粋)": "来期見通し", "短信PDF": "短信PDF(公式)", "新業種": "業種(新60)",
...
LEGEND = {
    ...
    "業種": "**業種** … 東証33業種の分類",
    "新業種": "**業種(新60)** … 独自の細分類(試験版)。確からしさは「業種根拠」で確認",
    "業種根拠": "**業種根拠** … 新60業種の分類の信頼度",
...
with tab_help:
    ...
    st.markdown(
        ...
        "- PERは黒字企業のみ算出（赤字は空欄）。\n"
        "- 金額は百万円表示（決算短信の一般的な単位）。業種(新60)は試験版です。"
    )
